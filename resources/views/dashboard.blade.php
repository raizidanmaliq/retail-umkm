    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class="table table-hover">
                ...
                <tbody>
                    <tr>
                        <td><img src="http://googleusercontent.com/file_content/3" alt="Dress" style="width: 50px; height: 50px; object-fit: cover;"> Dress Wanita <br><small class="text-muted">Kategori: Baju wanita</small></td>
                        <td>BW001</td>
                        <td>50</td>
                        <td>Rp. 85.000</td>
                        <td>Rp. 100.000</td>
                    ...
                    <tr>
                        <td><img src="http://googleusercontent.com/file_content/4" alt="Kemeja" style="width: 50px; height: 50px; object-fit: cover;"> Kemeja Formal <br><small class="text-muted">Kategori: Baju pria</small></td>
                        <td>KP001</td>
                        <td>50</td>
                        <td>Rp. 85.000</td>
                        <td>Rp. 100.000</td>
                    ...
                    <tr>
                        <td><img src="http://googleusercontent.com/file_content/5" alt="Kemeja" style="width: 50px; height: 50px; object-fit: cover;"> Kemeja <br><small class="text-muted">Kategori: Baju wanita</small></td>
                        <td>KE001</td>
                        <td>50</td>
                        <td>Rp. 85.000</td>
                        <td>Rp. 100.000</td>
                    ...
                    <tr>
                        <td><img src="http://googleusercontent.com/file_content/6" alt="Kaos" style="width: 50px; height: 50px; object-fit: cover;"> Kaos Polo <br><small class="text-muted">Kategori: Baju pria</small></td>
                        <td>KP001</td>
                        <td>50</td>
                        <td>Rp. 85.000</td>
                        <td>Rp. 100.000</td>
